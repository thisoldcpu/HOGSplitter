...
* **Whole-Hog Extraction:** Instantly unpack all embedded assets from any standard *Descent* archive into an organized local directory.
* **Surgical Precision:** Read the archive manifest to locate and extract specific individual files without executing a full archive dump.
